...
public class Context {
 ...
 //         this("resource:/edu/cmu/sphinx/api/default.config.xml", config);
    	  this("/home/thinh/Music/UntitledFolder/mydefault.config.xml", config);
//        this("/home/thinh/Music/UntitledFolder/frontend.config.xml", config);
    }
    ...
    public void setSpeechSource(InputStream stream, TimeFrame timeFrame) throws IOException {
        getInstance(StreamCepstrumSource.class).setInputStream(stream,true);
     ...
     * @throws IOException 
     */
    public void setSpeechSource(InputStream stream) throws IOException {
        getInstance(StreamCepstrumSource.class).setInputStream(stream,true);
        setLocalProperty("trivialScorer->frontend", "liveFrontEnd");
    }
