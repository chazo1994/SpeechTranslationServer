...
public class StreamSpeechRecognizer extends AbstractSpeechRecognizer {
    ...
    public void startRecognition(InputStream stream) throws IOException {
     ...
     */
    public void startRecognition(InputStream stream, TimeFrame timeFrame) throws IOException {
        recognizer.allocate();
